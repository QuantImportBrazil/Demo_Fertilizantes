...
<small>`*` O Sistema Harmonizado (SH) é uma nomenclatura internacional padronizada usada para classificar mercadorias no comércio exterior -  Organização Mundial das Alfândegas (OMA).  
** ou ainda; outros adubos (fertilizantes).  </small>
